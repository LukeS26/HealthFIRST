...
function openCommentField(el, cid) {
	if(id = null) {
		...
		//REPLYING TO COMMENT
		let commentField = `<div> <input placeholder="Comment" id="inputField${cid}"> <button onClick="makeComment('${cid}', document.getElementById("inputField${cid}").value)"> Submit </button> <button onClick="this.parent.remove()"> Cancel </button> </div>`
