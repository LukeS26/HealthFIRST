...
public class Account extends DataSchema {
	...
	/*
	 * TODO: For implementing email confirmations,
	 * - Generate a cryptographically secure key
	 * - Add that to a Mongo collection, linked to account by username
	 * (Maybe add the key to the Account Document in Mongo instead?)
	 ...
	 *
	 * Unconfirmed accounts cannot create posts, comments, etc.
	 */
	...
	public Document toDoc(boolean includeSecrets) {
		Document userDoc = new Document("username", username).append("biography", bio).append("profile_picture_link", profilePictureLink);
